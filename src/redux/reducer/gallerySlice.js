...
const Base_URL = "https://backend-gallerymern.onrender.com/api/v1";

export const getAllImages = createAsyncThunk(
  "images/fetchallimages",
  async () => {
    const res = await axios.get(`${Base_URL}/get/images`);
    return res.data;
  }
);
...
export const postNewCategory = createAsyncThunk(
  ...
  async (payload) => {
    const res = await axios.post(`${Base_URL}/add/category`, payload);
    return res.data;
  }
);
...
export const postNewImage = createAsyncThunk(
  "images/postnewimage",
  async (payload) => {
    const res = await axios.post(`${Base_URL}/upload/image`, payload);
    return res.data;
  }
);
...
export const getSingleImage = createAsyncThunk(
  ...
  async (payload) => {
    const res = await axios.get(
      `${Base_URL}/get/singleimage?category=${payload}`
    );
    return res.data;
  }
);
